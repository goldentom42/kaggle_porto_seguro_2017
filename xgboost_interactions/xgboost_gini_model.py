...
"""
Fold  1 score : 0.289520 in [  0.8]
Fold  2 score : 0.280142 in [  1.5]
Fold  3 score : 0.285491 in [  2.2]
Fold  4 score : 0.289022 in [  3.0]
Fold  5 score : 0.287388 in [  3.7]
Full OOF score : 0.286265
Public LB = 0.284
"""
...
class Level1Model(object):
    ...
    def add_municipalities(self):
        """ Add Municipalities """
        print("Adding Municipalities")
        self.trn['ps_reg_M'] = self.trn['ps_reg_03'].apply(lambda x: self.recon(x)[1])
        if self.do_submission:
            self.sub['ps_reg_M'] = self.sub['ps_reg_03'].apply(lambda x: self.recon(x)[1])
